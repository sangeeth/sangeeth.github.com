...
h2. 2.0 Deriving @Authorization@ HTTP Request Header Value

<a name="2_0"></a>

h3. 2.1 Twitter generated OAuth params
...
h3. 2.3 Building the OAuth Header Value
...
h2. 3.0 Invoking the Twitter API using cURL
